...
class GameSprite(sprite.Sprite):
    def _init_(self, player_image, player_x, player_y, player_speed, w = 200, h = 100):
        super ().__init__()
...
class Enemy(GameSprite):
    def update(self):
        global speed_y 
        global speed_x
        if ball.rect.y > win_height - 50 or ball.rect.y:
            speed_y *= -1 
...
player1 = Player('platform_png', 10,50, 4, 20, 100)
